import mainImg from '../../img/main_product_img.png';
...
function MainProduct() {
    return (
        <main class="main-product">
            ...
            <section class="main-product__center main-product__center_position">
                <div class="main-product__info">
                    <h4 class="main-product__info__header">WOMEN COLLECTION</h4>
                    <span class="main-product__bold-line"></span>
                    <h2 class="main-product__info__heading">MOSCHINO CHEAP AND
                        CHIC</h2>
                    <p class="main-product__info__text">Compellingly actualize
                        fully researched processes before proactive
                        outsourcing.
                        Progressively syndicate collaborative architectures
                        before cutting-edge services. Completely
                        visualize parallel core competencies rather than
                        exceptional portals. </p>
                    <p class="main-product__info__price">$561</p>
                    <p class="main-product__dividing-line"></p>
                    <div class="main-product__info__features">
                        <details>
                            <summary class="sort__summary"><span
                                class="sort__heading">CHOOSE COLOR</span>
                            ...
                            <p class="sort__list">Выбор цвета</p>
                        </details>
                        <details>
                            <summary class="sort__summary"><span
                                class="sort__heading">CHOOSE SIZE</span>
                                <svg width="11" height="6" viewBox="0 0 11 6"
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <p class="sort__list">Выбор размера</p>
                        </details>
                        <details>
                            <summary class="sort__summary"><span
                                class="sort__heading">QUANTITY</span> <svg
                            ...
                            <p class="sort__list">Выбор количества</p>
                        </details>
                    </div>
                    <button class="main-product__info__button">
